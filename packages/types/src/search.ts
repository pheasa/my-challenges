...
import type { ITeamWork } from "./workspace";
import type { IWorkspace } from "./workspace";

export type TSearchEntities = "user_mention" | "team_work" | "issue" | "project" | "cycle" | "module" | "page";
...
export type TTeamWorkSearchResponse = {
  avatar: ITeamWork["avatar"];
  id: ITeamWork["id"];
  name: ITeamWork["name"];
  role: ITeamWork["role"];
};
...
export type TSearchResponse = {
  ...
  team_work?: TTeamWorkSearchResponse[];
