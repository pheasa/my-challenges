    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          // Mindmap Detail
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/mindmaps/(detail)/layout.tsx", [
            route(
              ":workspaceSlug/projects/:projectId/mindmaps/:mindmapId",
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/mindmaps/(detail)/[mindmapId]/page.tsx"
            ),
          ]),

          // Mindmaps List
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/mindmaps/(list)/layout.tsx", [
            route(
              ":workspaceSlug/projects/:projectId/mindmaps",
