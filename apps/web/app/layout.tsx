...
export const meta = () => [
  { title: "My Challenges | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "My Challenges | Simple, extensible, open-source project management tool." },
  {
  ...
  { property: "og:image:alt", content: "My Challenges - Modern project management" },
  { name: "twitter:site", content: "@planepowers" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.plane.so/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "My Challenges - Modern project management" },
];
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="My Challenges" />
