...
export class WorkspaceService extends APIService {
  ...
  async fetchTeamWorks(workspaceSlug: string): Promise<ITeamWork[]> {
    return this.get(`/api/workspaces/${workspaceSlug}/team-works/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async createTeamWork(workspaceSlug: string, data: Partial<ITeamWork>): Promise<ITeamWork> {
    return this.post(`/api/workspaces/${workspaceSlug}/team-works/`, data)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async updateTeamWork(workspaceSlug: string, teamWorkId: string, data: Partial<ITeamWork>): Promise<ITeamWork> {
    return this.patch(`/api/workspaces/${workspaceSlug}/team-works/${teamWorkId}/`, data)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async deleteTeamWork(workspaceSlug: string, teamWorkId: string): Promise<void> {
    return this.delete(`/api/workspaces/${workspaceSlug}/team-works/${teamWorkId}/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async fetchProjectTeamWorks(workspaceSlug: string, projectId: string): Promise<ITeamWork[]> {
    return this.get(`/api/workspaces/${workspaceSlug}/projects/${projectId}/team-works/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async setProjectTeamWorks(
    workspaceSlug: string,
    projectId: string,
    teamWorkIds: string[]
  ): Promise<ITeamWork[]> {
    return this.post(`/api/workspaces/${workspaceSlug}/projects/${projectId}/team-works/set/`, {
      team_work_ids: teamWorkIds,
    })
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
