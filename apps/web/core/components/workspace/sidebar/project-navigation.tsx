...
import { CycleIcon, IntakeIcon, MindmapIcon, DiagramIcon, ModuleIcon, PageIcon, ViewsIcon, WorkItemsIcon } from "@plane/propel/icons";
...
export const ProjectNavigation = observer(function ProjectNavigation(props: TProjectItemsProps) {
  ...
  const baseNavigation = useCallback(
    (workspaceSlug: string, projectId: string): TNavigationItem[] => [
      ...
      {
        i18n_key: "sidebar.mindmaps",
        key: "mindmaps",
        name: "Mindmaps",
        href: `/${workspaceSlug}/projects/${projectId}/mindmaps`,
        icon: MindmapIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
        shouldRender: project?.mindmap_view ?? false,
        sortOrder: 6,
      },
      {
        i18n_key: "sidebar.diagrams",
        key: "diagrams",
        name: "Diagrams",
        href: `/${workspaceSlug}/projects/${projectId}/diagrams`,
        icon: DiagramIcon,
        access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER, EUserPermissions.GUEST],
        shouldRender: project?.diagram_view ?? false,
        sortOrder: 7,
      },
      {
