...
const APP_TITLE = "My Challenges Publish | Make your My Challenges boards public with one-click";
const APP_DESCRIPTION = "My Challenges Publish is a customer feedback management tool built on top of plane.so";
