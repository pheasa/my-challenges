...
class InstanceEndpoint(BaseAPIView):
    ...
    def get(self, request):
        ...
        # Self-heal: if an instance admin already exists but the setup flag was
        # never flipped (e.g. admin bootstrapped via create_admin_user), treat
        # setup as done so the app lands on the login page instead of the
        # instance setup/not-ready screens. Mirrors the guard used by the admin
        # sign-up endpoint.
        instance_data["is_setup_done"] = instance.is_setup_done or InstanceAdmin.objects.exists()
