...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/team-works/",
        TeamWorkViewSet.as_view({"get": "list", "post": "create"}),
        name="workspace-team-work",
    ),
    path(
        "workspaces/<str:slug>/team-works/<uuid:pk>/",
        TeamWorkViewSet.as_view({"get": "retrieve", "patch": "partial_update", "delete": "destroy"}),
        name="workspace-team-work",
    ),
    path(
