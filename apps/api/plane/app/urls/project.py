...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/team-works/",
        ProjectTeamWorkViewSet.as_view({"get": "list"}),
        name="project-team-work",
    ),
    path(
        "workspaces/<str:slug>/projects/<uuid:project_id>/team-works/set/",
        ProjectTeamWorkViewSet.as_view({"post": "set"}),
        name="project-team-work-set",
    ),
    path(
