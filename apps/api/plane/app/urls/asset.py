...
from plane.app.views import (
    ...
    UserAssetsEndpoint,
    FileAssetViewSet,
    # Local (no-S3) storage mode
    LocalAssetUploadEndpoint,
    LocalAssetServeEndpoint,
    # V2 Endpoints
...
urlpatterns = [
    ...
    path(
        ...
        LocalAssetUploadEndpoint.as_view(),
        name="local-asset-upload",
    ),
    path(
        "assets/v2/local/serve/",
        LocalAssetServeEndpoint.as_view(),
        name="local-asset-serve",
    ),
    # V2 Endpoints
    path(
