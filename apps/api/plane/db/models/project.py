...
class Project(BaseModel):
    ...
    team_work_lead = models.ForeignKey(
        "db.TeamWork",
    ...
    mindmap_view = models.BooleanField(default=False)
    diagram_view = models.BooleanField(default=False)
...
class ProjectTeamWork(ProjectBaseModel):
    team_work = models.ForeignKey(
        "db.TeamWork",
        on_delete=models.CASCADE,
    ...
    class Meta:
        unique_together = ["project", "team_work", "deleted_at"]
        constraints = [
            models.UniqueConstraint(
    ...
    def __str__(self):
        return f"{self.team_work.name} <{self.project.name}>"
