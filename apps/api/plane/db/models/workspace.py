...
class TeamWork(BaseModel):
    """A team work entry in a workspace (profile image, name and role/position)."""
    ...
    role = models.CharField(max_length=255, blank=True, null=True, verbose_name="Role / Position")
